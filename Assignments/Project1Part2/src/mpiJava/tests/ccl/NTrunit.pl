...
#
# A quick and dirty perl-script to compile and run ccl test codes
#

  @files = ('allgather', 'allreduce', 'alltoall', 'barrier', 
            'bcast', 'gather', 'reduce', 'reduce_scatter', 
            'scan', 'scatter');
...
#
  ...
  print "\nCompleted tests - cleaning up ccl directory \n";
